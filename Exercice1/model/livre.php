...
class Book{
    ...
    public __construct(string $book_name, string $genre, string $auteur_name,string $number_page){
    ...
    //getter
    public getBookName(){return $this->book_name;}

    public getBookType(){return $this->genre;}

    public getAuteurName(){return $this->auteur_name;}

    public getNumberPage(){return $this->number_page;}
